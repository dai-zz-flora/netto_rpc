...
import com.netto.server.handler.NettoFrame;
import com.netto.util.Constants;
import com.netto.util.JsonMapperUtil;
...
public class RpcTcpClient extends AbstactRpcClient {
	...
	protected Object invokeMethod(Method method, Object[] args) throws Throwable {
		...
		try {
			...
			String header = String.format("%s:%d/%d/%d",NettoFrame.NETTO_HEADER_START,2,headerContentBytes.length,byteBody.length);
			...
			ServiceResponse res = mapper.readValue(body, mapper.getTypeFactory().constructParametricType(ServiceResponse.class,
